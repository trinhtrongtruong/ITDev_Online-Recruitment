...
import { Col, Divider, Row, Skeleton, Tag, ConfigProvider } from 'antd';
                    ...
                    {jobDetail && jobDetail._id &&
                        <>
                            <Col span={24} md={16}>
                                ...
                                <div><HistoryOutlined />&nbsp;{dayjs(jobDetail.updatedAt).fromNow()}</div>
                                <Divider />
                            ...
                            <Col span={24} md={8}>
                                <div className={styles["company"]}>
                                    <div>
                                        <img style={{boxShadow:'1px 1px 5px #c5c5c5', borderRadius: '5px'}}
                                            alt="example"
