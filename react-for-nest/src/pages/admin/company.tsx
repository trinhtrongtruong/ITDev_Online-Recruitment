...
const CompanyPage = () => {
    ...
    const buildQuery = (params: any, sort: any, filter: any,  user: any) => {
        ...
        // Thêm điều kiện để chỉ lấy các công ty mà người dùng có quyền xem
        if (user?.company?._id) {
            temp = `${temp}&company._id=${user.company._id}`;
        }

        return temp;
    }
    // const fetchCompanies = async (params: any, sort: any, filter: any) => {
