...
export class UsersService {
  constructor(
    ...
    ) {}  // Type generic of ts Model<User> : ép kiểu Model cho User
  ...
  async remove(id: string, user: IUser) {
    ...
    if(foundUser && foundUser.email === this.configService.get<string>("ACCOUNT_ADMIN")){
      throw new BadRequestException(`Không thể xóa tài khoản ADMIN: ${foundUser.email}`);
    }
  ...
  async updateOne(id, payload: any) {
